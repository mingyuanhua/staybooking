...
// create compositary primary key based on stay_id and date
// since we use StayReservedDateKey as the primary key of StayReservedDate table,
// we need to mark it @Embeddable
@Embeddable
